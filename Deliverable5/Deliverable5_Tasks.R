...
full_sumamry$median_rent_per_night <- full_summary$Median_rent/7

full_summary$price_diff_per_night <- abs (full_summary$median_Airbnb_price - (full_sumamryMedian_rent_per_night))
